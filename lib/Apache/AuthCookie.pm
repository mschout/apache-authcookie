...
=method authen_ses_key($r, $session_key)
...
=method params($r): Apache::AuthCookie::Params
...
=method untaint_destination($uri)
...
=method send_cookie($session_key)
